...
print(f"   URL: http://localhost:5555/mcp")
print(f"   Verification Endpoint: http://localhost:5555/mcp/.well-known/mcp/verify")
print(f"   Capabilities Endpoint: http://localhost:5555/mcp/capabilities")
print("")
...
print("   URL: http://localhost:5555/mcp")
print(f"   Public Key: {PUBLIC_KEY}")
...
if __name__ == '__main__':
    print("🚀 Starting test MCP server on http://localhost:5555")
    print("")
