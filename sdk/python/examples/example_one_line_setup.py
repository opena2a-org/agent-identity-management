...
try:
    ...
    print(" SDK Download Mode not available (expected if using pip install)")
    print(f"   Error: {e}")
    print()
...
if capabilities:
    ...
    print(" No capabilities detected yet")
...
if mcps:
    ...
    print(" No MCP servers detected (expected if Claude Desktop not configured)")
print()
...
print("1 Getting user count (auto-verified)...")
try:
...
print("2 Fetching external data (auto-verified)...")
try:
