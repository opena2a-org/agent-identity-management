        ...
        <div className="p-6">
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 text-xs font-mono rounded">POST</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/agents/:id/suspend</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-xs font-mono rounded">POST</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/agents/:id/reactivate</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs font-mono rounded">POST</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/agents/:id/rotate-credentials</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs font-mono rounded">POST</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/agents/:id/verify</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-mono rounded">GET</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/compliance/status</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-mono rounded">GET</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/compliance/metrics</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-mono rounded">GET</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/compliance/access-review</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs font-mono rounded">POST</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/compliance/check</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-mono rounded">GET</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/compliance/data-retention</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-mono rounded">GET</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/compliance/violations</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-mono rounded">GET</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/admin/alerts</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs font-mono rounded">POST</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/admin/alerts/:id/acknowledge</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs font-mono rounded">POST</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/admin/alerts/:id/resolve</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-mono rounded">GET</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/admin/security-policies</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-mono rounded">GET</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/analytics/dashboard</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-mono rounded">GET</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/analytics/verification-activity</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-mono rounded">GET</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/analytics/trends</span>
                </div>
                <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <span className="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs font-mono rounded">GET</span>
                  <span className="text-sm font-mono text-gray-700 dark:text-gray-300">/api/v1/analytics/agents/activity</span>
                </div>
              </div>
            </div>
          </div>
