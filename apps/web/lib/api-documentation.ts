...
export interface APIEndpoint {
  ...
  requestSchema?: {
    type: string;
    properties: Record<string, { type: string; description: string; required?: boolean; example?: any }>;
  };
  responseSchema?: {
    type: string;
...
export const apiDocumentation: EndpointCategory[] = [
  {
    ...
    description: 'User authentication, JWT tokens, password management, and session control',
    icon: 'Lock',
    endpoints: [
      {
        method: 'POST',
        ...
        requestSchema: {
          type: 'object',
          properties: {
            email: { type: 'string', description: 'User email address', required: true, example: 'admin@example.com' },
            password: { type: 'string', description: 'User password', required: true, example: 'SecurePassword123!' },
          },
        },
        responseSchema: {
          type: 'object',
  ...
  "password": "SecurePassword123!"
      ...
      },
      {
        ...
        description: 'Alternative local authentication endpoint. Same as /public/login.',
  ...
  "password": "MyPassword123"
      ...
      },
      {
        ...
        description: 'Invalidate current session and JWT token. Clears authentication state.',
      ...
      },
      {
        ...
        description: 'Obtain new access token using refresh token. Implements token rotation for security.',
        ...
        requestSchema: {
          type: 'object',
          properties: {
            refreshToken: { type: 'string', description: 'Valid refresh token', required: true },
          },
        },
        responseSchema: {
          type: 'object',
          properties: {
            ...
            refreshToken: { type: 'string', description: 'New refresh token (token rotation)' },
          },
        },
        example: `{
  "refreshToken": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
      ...
      },
      {
        method: 'GET',
        path: '/api/v1/auth/me',
        description: 'Get current authenticated user profile. Returns user info, role, and organization.',
        ...
        responseSchema: {
          ...
          properties: {
            ...
            isApproved: { type: 'boolean', description: 'User approval status' },
          },
        },
  ...
  "newPassword": "NewSecurePassword456!"
      ...
      },
      {
        ...
        description: 'Request password reset email. Sends reset link to user email.',
  ...
  "email": "user@company.com"
      ...
      },
      {
        ...
        description: 'Reset password using token from email. Completes password reset flow.',
        ...
        requestSchema: {
          type: 'object',
          properties: {
            token: { type: 'string', description: 'Reset token from email', required: true },
...

  {
    ...
    description: 'Self-service user registration, approval workflows, and access requests',
    icon: 'User',
    endpoints: [
      {
        method: 'POST',
        path: '/api/v1/public/register',
        description: 'Register new user account. Creates pending user awaiting admin approval.',
        ...
        requestSchema: {
          ...
          properties: {
            email: { type: 'string', description: 'User email', required: true },
            password: { type: 'string', description: 'User password (min 8 chars)', required: true },
        ...
        responseSchema: {
          type: 'object',
          properties: {
            requestId: { type: 'string', description: 'Registration request ID' },
            status: { type: 'string', description: 'Registration status (pending)' },
  ...
  "organization": "Acme Corp"
      ...
      },
      {
        ...
        description: 'Check registration request status. Polls for admin approval.',
        ...
        responseSchema: {
          type: 'object',
          properties: {
            status: { type: 'string', description: 'Status (pending, approved, rejected)' },
            requestId: { type: 'string', description: 'Registration request ID' },
      ...
      },
      {
        ...
        description: 'Request platform access without password. Admin creates account and sends credentials.',
  ...
  "reason": "Need access for Q4 audit"
      ...
      },
      {
        ...
        description: 'Forced password change on first login. Enterprise security requirement.',
        ...
        requestSchema: {
          type: 'object',
          properties: {
            token: { type: 'string', description: 'Temporary login token', required: true },
            newPassword: { type: 'string', description: 'New password', required: true },
          },
        },
        example: `{
...

  {
    ...
    description: 'Complete agent CRUD operations, verification, suspension, and credential management',
    icon: 'Bot',
    endpoints: [
      {
        method: 'POST',
        path: '/api/v1/public/agents/register',
        description: 'ONE-LINE agent registration. Creates agent with Ed25519 keypair automatically.',
        ...
        requestSchema: {
          type: 'object',
          properties: {
            name: { type: 'string', description: 'Agent name', required: true, example: 'my-assistant' },
            type: { type: 'string', description: 'Agent type (ai_agent, mcp_server, automation_bot)', required: true },
        ...
        responseSchema: {
          ...
          properties: {
            ...
            privateKey: { type: 'string', description: 'Ed25519 private key (base64) - SAVE THIS!' },
            trustScore: { type: 'number', description: 'Initial trust score (50.0)' },
          },
        },
        example: `{
  ...
  "description": "AI agent for customer support"
      ...
      },
      {
        method: 'POST',
        path: '/api/v1/agents',
        description: 'Create new agent. Auto-generates Ed25519 keypair and assigns initial trust score.',
  ...
  "tags": ["production", "critical"]
      ...
      },
      {
        ...
        description: 'Get agent details by ID. Returns full agent profile with trust score.',
      ...
      },
      {
        method: 'PUT',
        path: '/api/v1/agents/:id',
        description: 'Update agent information. Can modify name, description, and tags.',
  ...
  "tags": ["updated", "tags"]
      ...
      },
      {
        method: 'DELETE',
        path: '/api/v1/agents/:id',
        description: 'Permanently delete agent. Requires manager role. Cannot be undone.',
      ...
      },
      {
        ...
        description: 'Suspend agent operations. Temporarily disables all agent actions.',
        ...
        requestSchema: {
          type: 'object',
          properties: {
            reason: { type: 'string', description: 'Suspension reason', required: true },
          },
        },
        example: `{
  "reason": "Security investigation"
      ...
      },
      {
        ...
        description: 'Rotate agent Ed25519 keypair. Generates new keys and invalidates old ones.',
        ...
        responseSchema: {
          ...
          properties: {
            ...
            privateKey: { type: 'string', description: 'New private key - SAVE THIS!' },
      ...
      },
      {
        ...
        description: 'Get raw Ed25519 public/private keys. For manual integration.',
        ...
        responseSchema: {
          ...
          properties: {
            publicKey: { type: 'string', description: 'Ed25519 public key (base64)' },
            privateKey: { type: 'string', description: 'Ed25519 private key (base64)' },
          },
        },
        example: 'No request body required',
      },
      {
        ...
        description: 'Download pre-configured SDK with embedded credentials. Python/Node.js/Go.',
      ...
      },
      {
        ...
        description: 'Get agent key vault info: public key, expiration, rotation status.',
      ...
      },
      {
        ...
        description: 'CORE: Runtime action verification. Verifies agent can perform action.',
  ...
  "context": {
    ...
    "subject": "Test Email"
      ...
      },
      {
        ...
        description: 'CORE: Log action result. Records verification outcome for audit.',
        ...
        requestSchema: {
          type: 'object',
          properties: {
            status: { type: 'string', description: 'Action status (success, failed)', required: true },
...

  {
    ...
    description: 'Manage which MCP servers each agent talks to, auto-detection, and mapping',
    icon: 'Plug',
    endpoints: [
      {
        method: 'GET',
        path: '/api/v1/agents/:id/mcp-servers',
        description: 'Get all MCP servers this agent talks to. Returns relationship list.',
        ...
        responseSchema: {
          type: 'object',
          properties: {
            mcpServers: { type: 'array', description: 'MCP servers agent communicates with' },
      ...
      },
      {
        method: 'PUT',
        path: '/api/v1/agents/:id/mcp-servers',
        description: 'Add MCP servers to agent (bulk). Creates "talks_to" relationships.',
        ...
        requestSchema: {
          type: 'object',
          properties: {
            mcpServerIds: { type: 'array', description: 'Array of MCP server IDs', required: true },
          },
        },
        example: `{
  "mcpServerIds": [
    ...
    "uuid-mcp-3"
      ...
      },
      {
        ...
        description: 'Remove single MCP server from agent. Deletes "talks_to" relationship.',
      ...
      },
      {
        ...
        description: 'Auto-detect MCP servers from agent config. Parses Claude Desktop config.',
        ...
        requestSchema: {
          type: 'object',
          properties: {
            configPath: { type: 'string', description: 'Path to Claude Desktop config' },
...

  {
    ...
    description: 'ML-powered 8-factor trust scoring, history tracking, and manual adjustments',
    icon: 'Shield',
    endpoints: [
      {
        method: 'GET',
        path: '/api/v1/agents/:id/trust-score',
        description: 'Get current agent trust score (0-100). ML algorithm based on 8 factors.',
        ...
        responseSchema: {
          type: 'object',
          properties: {
            trustScore: { type: 'number', description: 'Current score (0-100)' },
            lastCalculated: { type: 'string', description: 'Last calculation time' },
      ...
      },
      {
        ...
        description: 'Get trust score history over time. Returns time-series data.',
        ...
        responseSchema: {
          type: 'object',
          properties: {
            history: { type: 'array', description: 'Trust score history entries' },
      ...
      },
      {
        method: 'PUT',
        path: '/api/v1/agents/:id/trust-score',
        description: 'Manually update trust score. Admin-only. Creates audit log entry.',
        ...
        requestSchema: {
          type: 'object',
          properties: {
            trustScore: { type: 'number', description: 'New score (0-100)', required: true },
            reason: { type: 'string', description: 'Change reason', required: true },
          },
        },
        example: `{
  "trustScore": 85.5,
  "reason": "Manual adjustment after security review"
      ...
      },
      {
        ...
        description: 'Get trust score (alternative endpoint). Same as /agents/:id/trust-score.',
      ...
      },
      {
        ...
        description: 'Detailed trust score breakdown. Shows 8 factors with weights and contributions.',
...

  {
    ...
    description: 'Register, manage, and verify MCP servers with cryptographic authentication',
    icon: 'Server',
    endpoints: [
      {
        method: 'GET',
        path: '/api/v1/mcp-servers',
        description: 'List all MCP servers in organization. Supports filtering by status.',
        ...
        responseSchema: {
          type: 'object',
          properties: {
            mcpServers: { type: 'array', description: 'Array of MCP server objects' },
      ...
      },
      {
        method: 'POST',
        path: '/api/v1/mcp-servers',
        description: 'Register new MCP server. Creates server with Ed25519 keypair.',
...

  {
    ...
    description: 'Create, manage, and revoke SHA-256 hashed API keys with expiration',
    icon: 'Key',
    endpoints: [
      {
        method: 'GET',
      ...
      },
      {
        ...
        requestSchema: {
          ...
          properties: {
            ...
            expiresAt: { type: 'string', description: 'Expiration date (optional)' },
            scopes: { type: 'array', description: 'Permission scopes (optional)' },
          },
        },
        responseSchema: {
          type: 'object',
          properties: {
            apiKey: { type: 'string', description: 'Plain-text API key - SAVE THIS!' },
...

  {
    ...
    description: 'Agent verification history, real-time events, and verification statistics',
    icon: 'Activity',
    endpoints: [
      {
        method: 'GET',
        path: '/api/v1/verification-events',
        description: 'Get all verification events. Supports filtering and pagination.',
      ...
      },
      {
        ...
        description: 'Get verification statistics: success rate, failure rate, total count.',
        ...
        responseSchema: {
          ...
          properties: {
            ...
            failureRate: { type: 'number', description: 'Failure rate percentage' },
          },
        },
        example: 'No request body required',
      },
  ...
  {
    category: 'Webhooks',
    description: 'Event-driven integrations, webhook management, and delivery tracking',
    icon: 'Webhook',
    endpoints: [
      {
        method: 'GET',
...

  {
    ...
    description: 'Automatic detection of agents and MCP servers from config files',
    icon: 'Search',
    endpoints: [
      {
        method: 'POST',
...

  {
    ...
    description: 'Define and enforce security policies across agents and MCP servers',
    icon: 'ShieldCheck',
    endpoints: [
      {
        method: 'GET',
      ...
      },
      {
        ...
        requestSchema: {
          ...
          properties: {
            ...
            rules: { type: 'object', description: 'Policy rules', required: true },
...

  {
    ...
    description: 'Admin-only user management, role assignments, and access control',
    icon: 'Users',
    endpoints: [
      {
        method: 'GET',
      ...
      },
      {
        ...
        requestSchema: {
          type: 'object',
          properties: {
            role: { type: 'string', description: 'Assign role (admin, manager, member, viewer)', required: true },
          },
        },
        example: `{
  "role": "member"
    ...
    endpoints: [
      ...
      },
      {
        ...
        requestSchema: {
          type: 'object',
          properties: {
            reportType: { type: 'string', description: 'Report type (soc2, hipaa, gdpr)', required: true },
    ...
    endpoints: [
      ...
      },
      {
        ...
        requestSchema: {
          type: 'object',
          properties: {
            reportType: { type: 'string', description: 'Report type', required: true },
