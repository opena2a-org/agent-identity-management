...
func TestAdminEndpoints(t *testing.T) {
	...
	t.Run("GET /api/v1/admin/stats - Get system statistics", func(t *testing.T) {
		respBody := tc.AssertStatusCode("GET", "/api/v1/admin/stats", nil, tc.AdminToken, 200)
		...
		assert.Contains(t, result, "totalOrganizations")
	})
