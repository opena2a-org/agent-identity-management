...
func GeneratePythonSDK(config PythonSDKConfig) ([]byte, error) {
	...
	files := map[string]string{
		"aim_sdk/__init__.py":   generatePythonInitFile(version),
		"aim_sdk/client.py":     generatePythonClientFile(version),
		"aim_sdk/exceptions.py": pythonExceptionsFile,
		"aim_sdk/config.py":     generatePythonConfig(config),
		"setup.py":              generatePythonSetupFile(version),
...
// generatePythonInitFile generates __init__.py with the correct version
func generatePythonInitFile(version string) string {
	return fmt.Sprintf(`"""
...
// generatePythonClientFile generates client.py with the correct version in User-Agent
func generatePythonClientFile(version string) string {
	return fmt.Sprintf(`"""
...
// generatePythonSetupFile generates setup.py with the correct version
func generatePythonSetupFile(version string) string {
